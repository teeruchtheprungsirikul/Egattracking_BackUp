...
class AddReportForm7 extends StatefulWidget {
  ...
  AddReportForm7({ReportDao reportDao = null}) {
...
class MyCustomAddReportForm7State extends BaseStatefulState<AddReportForm7> {
  ...
  MyCustomAddReportForm7State({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(child: Text("งานจ้างเหมาแรงงานท้องถิ่นตรวจ และบำรุงรักษาสายส่ง",
                                ...
                                onPressed: () {
                                  ...
                                  if (_formKey.currentState.validate()) {
                                    ...
                                    body.add({
                                      "key": "name",
                                      "type": "string",
                                      "value": "งานจ้างเหมาแรงงานท้องถิ่นตรวจ และบำรุงรักษาสายส่ง"
                                    });
                                    for (var i = 0; i < topic.length; i++) {
