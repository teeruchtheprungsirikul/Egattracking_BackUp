...
class AddReportForm20 extends StatefulWidget {
  ...
  AddReportForm20({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }

  @override
  MyCustomAddReportForm20State createState() {
    return MyCustomAddReportForm20State(reportDao: reportDao);
  }
}

// Create a corresponding State class.
// This class holds data related to the form.
class MyCustomAddReportForm20State extends BaseStatefulState<AddReportForm20> {
  ...
  MyCustomAddReportForm20State({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.fromLTRB(
                                20.0, 0.0, 20.0, 0.0),
                            child: Text("ความก้าวหน้าแผนพิเศษ",
