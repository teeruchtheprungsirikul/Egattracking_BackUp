...
class AddReportForm6 extends StatefulWidget {
  ...
  AddReportForm6({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }

  @override
  MyCustomAddReportForm6State createState() {
    return MyCustomAddReportForm6State(reportDao: reportDao);
  }
}

// Create a corresponding State class.
// This class holds data related to the form.
class MyCustomAddReportForm6State extends BaseStatefulState<AddReportForm6> {
  ...
  MyCustomAddReportForm6State({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }
