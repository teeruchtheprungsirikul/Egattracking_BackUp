...
class AddReportForm3 extends StatefulWidget {
  ...
  MyCustomAddReportForm3State createState() {
    return MyCustomAddReportForm3State(reportDao: reportDao);
  }
}

// Create a corresponding State class.
// This class holds data related to the form.
class MyCustomAddReportForm3State extends BaseStatefulState<AddReportForm3> {
                                ...
                                onPressed: () {
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    body.add({
                                      "key": "name",
                                      "type": "string",
                                      "value": "ตรวจสายส่งโดยวิธี Cross check"
                                    });
                                    body.add({
                                      "key": Topic.urgent[0],
                                      "type": "string",
