...
class AddReportForm13 extends StatefulWidget {
  var reportDao;

  AddReportForm13({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }
  @override
  MyCustomAddReportForm13State createState() {
    return MyCustomAddReportForm13State(reportDao: reportDao);
  }
}

// Create a corresponding State class.
// This class holds data related to the form.
class MyCustomAddReportForm13State extends BaseStatefulState<AddReportForm13> {
  ...
  MyCustomAddReportForm13State({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }
  ...
  List<String> topic = Topic.report13;
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(child: Text("งานบำรุงสาย Conductor & OHGW. & OPGW",
                                ...
                                onPressed: () {
                                  ...
                                  if (_formKey.currentState.validate()) {
                                    ...
                                    body.add({
                                      "key": "name",
                                      "type": "string",
                                      "value": "งานบำรุงสาย Conductor & OHGW. & OPGW"
                                    });
                                    for (var i = 0; i < topic.length; i++) {
