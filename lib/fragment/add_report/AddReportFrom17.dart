...
class AddReportForm17 extends StatefulWidget {
  final reportDao;

  AddReportForm17({Key? key, this.reportDao}) : super (key: key); 
 
  @override
  MyCustomAddReportForm17State createState() {
    return MyCustomAddReportForm17State(reportDao: reportDao);
  }
}

// Create a corresponding State class.
// This class holds data related to the form.
class MyCustomAddReportForm17State extends BaseStatefulState<AddReportForm17> {
  ...
  MyCustomAddReportForm17State({ReportDao? reportDao }) {
  ...
  List<String> topic = Topic.report17;
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(child: Text("งานตรวจสอบและติดตามการรุกล้ำเขตเดินสาย",
                                ...
                                onPressed: () {
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    body.add({
                                      "key": "name",
                                      "type": "string",
                                      "value": "งานตรวจสอบและติดตามการรุกล้ำเขตเดินสาย"
                                    });
                                    for (var i = 0; i < topic.length; i++) {
