...
class AddReportForm15 extends StatefulWidget {
  var reportDao;

  AddReportForm15({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }
  @override
  MyCustomAddReportForm15State createState() {
    return MyCustomAddReportForm15State(reportDao: reportDao);
  }
}

// Create a corresponding State class.
// This class holds data related to the form.
class MyCustomAddReportForm15State extends BaseStatefulState<AddReportForm15> {
  ...
  MyCustomAddReportForm15State({ReportDao reportDao = null}) {
    this.reportDao = reportDao;
  }
  ...
  List<String> topic = Topic.report15;
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(child: Text("การตรวจสอบบำรุงรักษาระบบไฟสัญญาณทางอากาศ",
                                ...
                                onPressed: () {
                                  ...
                                  if (_formKey.currentState.validate()) {
                                    ...
                                    body.add({
                                      "key": "name",
                                      "type": "string",
                                      "value": "การตรวจสอบบำรุงรักษาระบบไฟสัญญาณทางอากาศ"
                                    });
                                    for (var i = 0; i < topic.length; i++) {
